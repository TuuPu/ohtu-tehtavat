...
class TestKassapaate(unittest.TestCase):
    ...
    def test_kassapaate_lataa_kutsu_lisaa_maksukortille_ladattavan_rahamaaran(self):
        maksukortti_mock = Mock()
    ...
    def test_kassapaate_ei_lataa_rahaa_maksukortille_jos_summa_negatiivinen(self):
        maksukortti_mock = Mock()
        maksukortti_mock.saldo = 0
